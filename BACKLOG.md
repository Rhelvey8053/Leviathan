...
| 5 | cli-scorer-json-schema-and-cwd-isolation | User asked (2026-09-14) to identify the highest-value repos/techniques to improve performance, quality, or token optimization -- research traced the actual scorer.py CLI call path instead of only… | infra |
