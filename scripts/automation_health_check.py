...
TASK_CADENCE_HOURS = {
    ...
    "Leviathan-AIResearchScan":         120.0,   # Wed+Sun 12:20pm (2026-09-14, was
                                                  # Sunday-only) -- worst-case gap between
                                                  # runs is 96h (Wed->Sun), +24h margin,
                                                  # same philosophy as the other entries here
}
