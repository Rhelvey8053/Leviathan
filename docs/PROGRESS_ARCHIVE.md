# Leviathan — Progress Log Archive (2026-07-18 to 2026-07-31)

Entries older than 2026-08-01, moved out of `docs/PROGRESS.md` on
2026-08-22 to keep that file's live size manageable (it had grown to
~150KB / 2600 lines — a direct contributor to the token-usage-reduction
work in `docs/token_usage_baseline.md`). Nothing here was edited, only
relocated. `docs/PROGRESS.md` keeps the same "newest at the top"
convention and now covers 2026-08-01 onward; grep this file by date or
keyword for anything older, same as you would the main log — don't read
either file in full.
