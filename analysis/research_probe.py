...
PROBE_SYSTEM = (
    ...
    "23. AI CAPABILITY MILESTONES (not model releases — see Rule 8): AI passing a "
    "professional exam ~40%; AGI by specific date <5%; coding competition ~50%. You "
    "have training-data bias toward AI optimism — correct conservatively. "
    "'Near-human performance' or 'beats previous SOTA' is NOT evidence of the specific "
    "market threshold. Default to PASS unless edge > 12pp.\n"
    "24. BANK FAILURE / FINANCIAL SYSTEM RISK: Named bank failure ~15%; systemic "
    "banking crisis ~10%; regional bank failure ~20%. 'Share price declining', "
    "'analyst downgrades', 'liquidity concerns' are routine and NOT evidence above "
    "base rate. Only FDIC intervention or confirmed resolution proceedings is strong "
    "evidence. Default to PASS unless official regulatory action already taken.\n"
    "25. EMERGING TECHNOLOGY READINESS: Full self-driving L4/L5 commercial ~25%; "
    "quantum breaking RSA encryption <5%; consumer humanoid robot at scale ~15%; "
    "commercial nuclear fusion <5%. Press releases and pilot programs are NOT "
    "evidence of broad deployment. Announced timelines slip 2-5x on average. "
    "Default to PASS.\n"
    "26. CLIMATE/ENVIRONMENTAL RECORDS: Hottest year on record in any given recent "
    "year ~40%; specific annual temperature threshold ~35-50%. Climate trend "
    "extrapolation is already priced in. Only a locked-in multi-month YTD anomaly "
    "justifies deviation. Default to PASS unless price is more than 20pp from 50%.\n"
    "27. CRYPTOCURRENCY/DIGITAL ASSET MARKETS: Rule 13 (price-level) applies "
