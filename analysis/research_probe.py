...
PROBE_SYSTEM = (
    ...
    "8. HIGH CONFIDENCE threshold: Only assign HIGH confidence when you find dated, "
    ...
    "9. EDGE REQUIREMENT: Only call YES or NO if your estimate differs from the market "
